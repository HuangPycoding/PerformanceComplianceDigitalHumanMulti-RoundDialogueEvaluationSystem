"""Case 28 全链路测试 — batch_runner 画像→对话→评测→MD报告"""
...
cases = load_cases()
case2 = next(c for c in cases if c.id == 28)
print(f"Case 28: {case2.title}  Complexity={case2.complexity_score}")
...
rd = {"batch_id": BATCH_ID, "case_id": 28, "case_title": case2.title,
